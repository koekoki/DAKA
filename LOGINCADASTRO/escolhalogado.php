...
<html lang="pt-br"></html>
    ...
    <body>
        <header style="height: 100px;">
            ...
            <a class="cta" href="login.php">Voltar</a>
            <a class="abc" href="perfil1.php ">Perfil</a>
            <nav>
            </nav>
        ...
        <a class="humanas" href="humanaslogin.php" 
        style="
        ...
        <a class="exatas" href="exataslogin.php" 
        style="
        text-decoration: none;
        box-shadow: 0 0 10px rgb(125, 137, 146);
        color: #012;
        ...
        <a class="biologicas" href="biologin.php" 
        style="
        text-decoration: none;
        color: #012;
        box-shadow: 0 0 10px rgb(125, 137, 146);
        ...
        <a class="linguagens" href="lingualogin.php" 
        style="
        text-decoration: none;
        color: #012;
        box-shadow: 0 0 10px rgb(125, 137, 146);
        ...
        <a class="bonequinho"><img src="https://cdn.discordapp.com/attachments/802254748782690314/812406623687409714/bonequinho_daka.png" style="margin-left: 75%; height: 60%; "></a>
